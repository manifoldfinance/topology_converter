...
## Changelog:
* v5\.0\.0 2021\_??\_??:  Refactored code structure. Changed default value for vagrant interface attribute for Cumulus Linux. Added support for eth0 on fake nodes in conjunction with Auto Management Network feature. Updated CI validation.
